...
# --- File Name: collect_results_fac.py
# --- Creation Date: 13-09-2020
# --- Last Modified: Sun 13 Sep 2020 16:22:23 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
Collect results of factor_vae.
"""
...
def get_hyps_seed(sub_path):
    ...
    if os.path.exists(config_json):
        with open(config_json, 'r') as f:
            data = json.load(f)
        return data['factor_vae.gamma'], data['model.random_seed']
    else:
        return None, None

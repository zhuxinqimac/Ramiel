...
# --- File Name: collect_results_annealed.py
# --- Creation Date: 14-09-2020
# --- Last Modified: Mon 14 Sep 2020 02:05:54 AEST
# --- Author: Xinqi Zhu
# .<.<.<.<.<.<.<.<.<.<.<.<.<.<.<.<
"""
Collect results of annealed_vae.
"""
...
def get_hyps_seed(sub_path):
    ...
    if os.path.exists(config_json):
        with open(config_json, 'r') as f:
            data = json.load(f)
        return data['annealed_vae.c_max'], data['model.random_seed']
    else:
        return None, None
